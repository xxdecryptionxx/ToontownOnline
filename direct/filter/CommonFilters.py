...
class CommonFilters:
    ...
    def setBloom(self, blend = (0.29999999999999999, 0.40000000000000002, 0.29999999999999999, 0.0), mintrigger = 0.59999999999999998, maxtrigger = 1.0, desat = 0.59999999999999998, intensity = 1.0, size = 'medium'):
        if size == 0:
            size = 'off'
        elif size == 1:
            size = 'small'
    ...
    def setVolumetricLighting(self, caster, numsamples = 32, density = 5.0, decay = 0.10000000000000001, exposure = 0.10000000000000001):
    ...
    def setAmbientOcclusion(self, numsamples = 16, radius = 0.050000000000000003, amount = 2.0, strength = 0.01, falloff = 1.9999999999999999e-006):
