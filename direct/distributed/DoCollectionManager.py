...
class DoCollectionManager:
    ...
    def storeObjectLocation(self, object, parentId, zoneId):
        ...
        if oldParentId != parentId:
            ...
            return None
        if not parentId is None and zoneId is None:
            if parentId == zoneId:
                pass
            zoneId == 0
            if 1:
    ...
    storeObjectLocation = exceptionLogged()(storeObjectLocation)
    ...
    def isValidLocationTuple(self, location):
        if location is not None and location != (0xFFFFFFFFL, 0xFFFFFFFFL):
            pass
        return location != (0, 0)
