...
class DirectWaitBar(DirectFrame):
    ...
    def __init__(self, parent = None, **kw):
        optiondefs = (('pgFunc', PGWaitBar, None), ('frameSize', (-1, 1, -0.080000000000000002, 0.080000000000000002), None), ('borderWidth', (0, 0), None), ('range', 100, self.setRange), ('value', 0, self.setValue), ('barBorderWidth', (0, 0), self.setBarBorderWidth), ('barColor', (1, 0, 0, 1), self.setBarColor), ('barTexture', None, self.setBarTexture), ('barRelief', DGG.FLAT, self.setBarRelief), ('sortOrder', NO_FADE_SORT_INDEX, None))
        if kw.has_key('text'):
