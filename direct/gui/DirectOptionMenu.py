...
class DirectOptionMenu(DirectButton):
    ...
    def __init__(self, parent = None, **kw):
        optiondefs = (('items', [], self.setItems), ('initialitem', None, DGG.INITOPT), ('popupMarkerBorder', (0.10000000000000001, 0.10000000000000001), None), ('highlightColor', (0.5, 0.5, 0.5, 1), None), ('highlightScale', (1, 1), None), ('text_align', TextNode.ALeft, None), ('pressEffect', 0, DGG.INITOPT))
        self.defineoptions(kw, optiondefs)
        DirectButton.__init__(self, parent)
        self.initFrameSize = self['frameSize']
        self.popupMarker = self.createcomponent('popupMarker', (), None, DirectFrame, (self,), frameSize = (-0.5, 0.5, -0.20000000000000001, 0.20000000000000001), scale = 0.40000000000000002, relief = DGG.RAISED)
