...
class DirectManipulationControl(DirectObject):
    ...
    def __init__(self):
        ...
        self.actionEvents = [
            [
                'DIRECT-mouse1',
                self.manipulationStart],
            [
                'DIRECT-mouse1Up',
                self.manipulationStop],
            [
                'tab',
                self.toggleObjectHandlesMode],
            [
            ...
            [
                'shift-f',
                self.objectHandles.growToFit],
            [
                'i',
                self.plantSelectedNodePath]]
    ...
    def drawMarquee(self, startX, startY):
        ...
        self.marquee = LineNodePath(render2d, 'marquee', 0.5, VBase4(0.80000000000000004, 0.59999999999999998, 0.59999999999999998, 1))
    ...
    def spawnManipulateObjectTask(self):
        ...
        t.fMouseX = abs(base.direct.dr.mouseX) > 0.90000000000000002
        t.fMouseY = abs(base.direct.dr.mouseY) > 0.90000000000000002
        if t.fMouseX:
            t.constrainedDir = 'y'
        else:
            t.constrainedDir = 'x'
    ...
    def widgetCheck(self, type):
        ...
        if type == 'top?':
            ...
            return abs(widgetDir.dot(widgetAxis)) < 0.20000000000000001
...
class ObjectHandles(NodePath, DirectObject):
    ...
    def __init__(self, name = 'objectHandles'):
        ...
        self.xDisc.setColor(1, 0, 0, 0.20000000000000001)
        self.yPostCollision.hide()
        self.yRingCollision.hide()
        self.yDisc.setColor(0, 1, 0, 0.20000000000000001)
        self.zPostCollision.hide()
        self.zRingCollision.hide()
        self.zDisc.setColor(0, 0, 1, 0.20000000000000001)
    ...
    def disabledModeColor(self):
        self.setColor(0.10000000000000001, 0.10000000000000001, 0.10000000000000001, 0.10000000000000001, 1)
    ...
    def growToFit(self):
        ...
        sf = 0.14999999999999999 * minDim * (pos[1] / base.direct.dr.near)
    ...
    def createObjectHandleLines(self):
        ...
        arrowInfo0 = 1.3
        arrowInfo1 = 0.10000000000000001
        lines.moveTo(1.5, 0, 0)
