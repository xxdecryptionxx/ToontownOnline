...
class ContainerLeakDetector(Job):
    ...
    addPrivateObj = classmethod(addPrivateObj)
    
    def removePrivateObj(cls, obj):
        cls.PrivateIds.remove(id(obj))

    removePrivateObj = classmethod(removePrivateObj)
    ...
    def getContainerByIdGen(self, id, **kwArgs):
        return self._id2ref[id].getContainerGen(**None)
    ...
    def getContainerNameByIdGen(self, id, **kwArgs):
        return self._id2ref[id].getEvalStrGen(**None)
