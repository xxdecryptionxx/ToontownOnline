...
class Loader(DirectObject):
    ...
    def __init__(self, base):
        ...
        self.accept(self.hook, self._Loader__gotAsyncObject)
    ...
    def loadSfx(self, *args, **kw):
        if self.base.sfxManagerList:
            return self.loadSound(self.base.sfxManagerList[0], *args, **args)
        

    
    def loadMusic(self, *args, **kw):
        if self.base.musicManager:
            return self.loadSound(self.base.musicManager, *args, **args)
        else:
            return None
    ...
    def asyncFlattenStrong(self, model, inPlace = True, callback = None, extraArgs = []):
        ...
        if inPlace:
            extraArgs = [
                ...
                modelList,
                extraArgs]
            callback = self._Loader__asyncFlattenDone
            gotList = True
    ...
    def _Loader__asyncFlattenDone(self, models, gotList, callback, origModelList, extraArgs):
    ...
    def _Loader__gotAsyncObject(self, request):
