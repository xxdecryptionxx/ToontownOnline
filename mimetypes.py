...
global inited, guess_type, guess_all_extensions, guess_extension, add_type, suffix_map, encodings_map, types_map, common_types
import os
import posixpath
import urllib
__all__ = [
...
def init(files = None):
    global inited, encodings_map, suffix_map, types_map, guess_all_extensions, guess_extension, guess_type, add_type, common_types
    inited = True
    db = MimeTypes()
    if files is None:
        files = knownfiles
