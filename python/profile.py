...
def help():
    for dirname in sys.path:
        ...
        print 'Sorry, can\'t find the help file "profile.doc"', 'along the Python search path.'
...
def Stats(*args):
    print 'Report generating functions are in the "pstats" module\x7'
