...
def disassemble(co, lasti = -1):
    ...
    while i < n:
        ...
        if i in labels:
            ...
            print '  ',
        print repr(i).rjust(4), opname[op].ljust(20)i = i + 1if op >= HAVE_ARGUMENT:
            ...
            print repr(oparg).rjust(5)if op in hasconst:
...
def disassemble_string(code, lasti = -1, varnames = None, names = None, constants = None):
    ...
    while i < n:
        ...
        if i in labels:
            ...
            print '  ',
        print repr(i).rjust(4), opname[op].ljust(15)i = i + 1if op >= HAVE_ARGUMENT:
