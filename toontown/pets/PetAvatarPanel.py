...
class PetAvatarPanel(AvatarPanel.AvatarPanel):
    ...
    def __init__(self, avatar):
        ...
        self.frame.show()
        if self.petIsLocal:
            proxTask = Task.loop(Task(self._PetAvatarPanel__checkPetProximity), Task.pause(0.5))
