...
class PetLookerAI:
    ...
    def enterPetLook(self):
        ...
        self._PetLookerAI__collNode = self._getPetLookerBodyNode().attachNewNode('PetLookerCollNode')
    ...
    def _createPetLookSphere(self):
        ...
        self.lookSphereNodePath = self._PetLookerAI__collNode.attachNewNode(lookSphereNode)
