...
class InviteVisual(DirectFrame):
    ...
    def __init__(self, parent):
        ...
        self.inviteThemesIdToInfo = {
            ...
            PartyGlobals.InviteTheme.GenericMale: (self.gui.find('**/genericMalePage'), TTLocalizer.PartyPlannerGenericMaleTheme, (0.69999999999999996, 0.69999999999999996, 0.0, 1.0)),
        ...
        self.whosePartyLabel = DirectLabel(parent = self, relief = None, pos = self.gui.find('**/who_locator').getPos(), text = '.', text_scale = 0.067000000000000004, textMayChange = True)
