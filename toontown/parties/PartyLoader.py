...
class PartyLoader(SafeZoneLoader.SafeZoneLoader):
    ...
    def load(self):
        ...
        base.win.setClearColor(Vec4(0.46999999999999997, 0.68999999999999995, 0.29999999999999999, 1.0))
    ...
    def enter(self, requestStatus):
        ...
        self.accept(FireworksStartedEvent, self._PartyLoader__handleFireworksStarted)
        self.accept(FireworksFinishedEvent, self._PartyLoader__handleFireworksFinished)
    ...
    def switchToNight(self):
        ...
        self.dayChangeInterval = Sequence(self.sunMoonNode.hprInterval(5.0, Point3(0, -30, 0), blendType = 'easeInOut'), Func(base.win.setClearColor, Vec4(0.14999999999999999, 0.22, 0.14000000000000001, 1.0)))
        self.dayChangeInterval.start()

    
    def switchToDay(self):
        self.dayChangeInterval = Sequence(Func(base.win.setClearColor, Vec4(0.46999999999999997, 0.68999999999999995, 0.29999999999999999, 1.0)), self.sunMoonNode.hprInterval(5.0, Point3(0, 30, 0), blendType = 'easeInOut'))
        self.dayChangeInterval.start()
