...
class ServerTimeGui(DirectFrame):
    ...
    def createGuiObjects(self):
        ...
        self.hourLabel = DirectLabel(parent = self, pos = (-0.014999999999999999, 0, 0), relief = None, text = '', text_scale = textScale, text_align = TextNode.ARight, text_font = timeFont)
        ...
        self.minutesLabel = DirectLabel(relief = None, parent = self, pos = (0.014999999999999999, 0, 0), text = '', text_scale = textScale, text_align = TextNode.ALeft, text_font = timeFont)
        self.amLabel = DirectLabel(relief = None, parent = self, pos = (0.14000000000000001, 0, 0), text = '', text_scale = textScale, text_align = TextNode.ALeft, text_font = timeFont)
