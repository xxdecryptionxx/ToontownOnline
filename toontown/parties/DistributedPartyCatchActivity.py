...
class DistributedPartyCatchActivity(DistributedPartyActivity, DistributedPartyCatchActivityBase):
    ...
    def load(self, loadModels = 1, arenaModel = 'partyCatchTree'):
        ...
        self.treesAndFence.find('**/fence_floor').setPos(0.0, 0.0, 0.10000000000000001)
        ...
        exitText.setCardAsMargin(0.10000000000000001, 0.10000000000000001, 0.10000000000000001, 0.10000000000000001)
        ...
        self._DistributedPartyCatchActivity__textGen = TextNode('partyCatchActivity')
        self._DistributedPartyCatchActivity__textGen.setFont(ToontownGlobals.getSignFont())
    ...
    def getDropIval(self, x, y, dropObjName, generation, num):
        ...
        self.accept(catchEventName, Functor(eatCollEntry, Functor(self._DistributedPartyCatchActivity__handleCatch, id[0], id[1])))
    ...
    def startConclusion(self):
        ...
        perfectTextSubnode = hidden.attachNewNode(self._DistributedPartyCatchActivity__genText(finishText))
