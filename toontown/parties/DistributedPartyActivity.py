...
class DistributedPartyActivity(DistributedObject.DistributedObject):
    ...
    def loadSign(self):
        ...
        text.setTextColor(0.20000000000000001, 0.10000000000000001, 0.69999999999999996, 1.0)
        ...
        self.noteText.setPosHpr(self.signTextLocator, 0.0, 0.0, 0.20000000000000001, 0.0, 0.0, 0.0)
    ...
    def loadLever(self):
        ...
        cs = CollisionTube(0.0, 2.7000000000000002, 0.0, 0.0, 2.7000000000000002, 3.0, 1.2)
    ...
    def getToonPullingLeverInterval(self, toon):
        ...
        leverSeq = Sequence(Wait(walkTime + reach.getDuration() - 0.10000000000000001), self.stick.hprInterval(0.55000000000000004, Point3(0.0, 25.0, 0.0), Point3(0.0, 0.0, 0.0)), Wait(0.29999999999999999), self.stick.hprInterval(0.40000000000000002, Point3(0.0, 0.0, 0.0), Point3(0.0, 25.0, 0.0)))
    ...
    def showMessage(self, message, endState = 'walk'):
        ...
        self.acceptOnce(self.messageDoneEvent, self._DistributedPartyActivity__handleMessageDone)
    ...
    def showJellybeanReward(self, earnedAmount, jarAmount, message):
        if not self.isLocalToonInActivity() or base.localAvatar.doId in self.getToonIdsAsList():
            ...
            base.cr.playGame.getPlace().fsm.request('activity')
            self.acceptOnce(self.showRewardDoneEvent, self._DistributedPartyActivity__handleJellybeanRewardDone)
