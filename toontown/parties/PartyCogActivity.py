...
class PartyCogActivity(DirectObject):
    ...
    def load(self):
        ...
        self.winStatus = self.createText(2, Point3(0.0, 0.0, -0.80000000000000004), self.teamColors[0])
