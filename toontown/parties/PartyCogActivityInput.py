...
class PartyCogActivityInput(DirectObject):
    ...
    def enableAimKeys(self):
        ...
        self.accept(ROTATE_LEFT_KEY, self._PartyCogActivityInput__handleLeftKeyPressed)
        self.accept(ROTATE_RIGHT_KEY, self._PartyCogActivityInput__handleRightKeyPressed)
        self.accept(FORWARD_KEY, self._PartyCogActivityInput__handleUpKeyPressed)
        self.accept(BACKWARDS_KEY, self._PartyCogActivityInput__handleDownKeyPressed)
    ...
    def _PartyCogActivityInput__handleLeftKeyPressed(self):
        self.ignore(ROTATE_LEFT_KEY)
        self.accept(ROTATE_LEFT_KEY + '-up', self._PartyCogActivityInput__handleLeftKeyReleased)
        self._PartyCogActivityInput__leftPressed()

    
    def _PartyCogActivityInput__handleRightKeyPressed(self):
        self.ignore(ROTATE_RIGHT_KEY)
        self.accept(ROTATE_RIGHT_KEY + '-up', self._PartyCogActivityInput__handleRightKeyReleased)
    ...
    def _PartyCogActivityInput__handleUpKeyPressed(self):
        self.ignore(FORWARD_KEY)
        self.accept(FORWARD_KEY + '-up', self._PartyCogActivityInput__handleUpKeyReleased)
    ...
    def _PartyCogActivityInput__handleDownKeyPressed(self):
        self.ignore(BACKWARDS_KEY)
        self.accept(BACKWARDS_KEY + '-up', self._PartyCogActivityInput__handleDownKeyReleased)
    ...
    def _PartyCogActivityInput__leftPressed(self):
        self.leftPressed = self._PartyCogActivityInput__enterControlActive(self.leftPressed)

    
    def _PartyCogActivityInput__rightPressed(self):
        self.rightPressed = self._PartyCogActivityInput__enterControlActive(self.rightPressed)

    
    def _PartyCogActivityInput__upPressed(self):
        self.upPressed = self._PartyCogActivityInput__enterControlActive(self.upPressed)

    
    def _PartyCogActivityInput__downPressed(self):
        self.downPressed = self._PartyCogActivityInput__enterControlActive(self.downPressed)

    
    def _PartyCogActivityInput__leftReleased(self):
        self.leftPressed = self._PartyCogActivityInput__exitControlActive(self.leftPressed)

    
    def _PartyCogActivityInput__rightReleased(self):
        self.rightPressed = self._PartyCogActivityInput__exitControlActive(self.rightPressed)

    
    def _PartyCogActivityInput__upReleased(self):
        self.upPressed = self._PartyCogActivityInput__exitControlActive(self.upPressed)

    
    def _PartyCogActivityInput__downReleased(self):
        self.downPressed = self._PartyCogActivityInput__exitControlActive(self.downPressed)
