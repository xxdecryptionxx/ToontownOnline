...
class KeyCodesGui(DirectObject):
    ...
    def __init__(self, keyCodes, yOffset = 0.55000000000000004, keyToIndex = KEY_TO_INDEX):
    ...
    def load(self):
        ...
        self._danceMoveLabel = OnscreenText(parent = aspect2d, text = '', pos = (0, self._yOffset), scale = 0.14999999999999999, align = TextNode.ACenter, font = ToontownGlobals.getSignFont(), fg = Vec4(1, 1, 1, 1), mayChange = True)
    ...
    def _KeyCodesGui__startTimeout(self):
        self._KeyCodesGui__stopTimeout()
        self.timeoutTask = taskMgr.doMethodLater(KEYCODE_TIMEOUT_SECONDS, self._KeyCodesGui__handleTimeoutTask, KeyCodesGui.TIMEOUT_TASK)
