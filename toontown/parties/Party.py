...
class Party(Place.Place):
    ...
    def enterTeleportIn(self, requestStatus):
        ...
        if hasattr(base, 'distributedParty'):
            ...
            self.acceptOnce(DistributedParty.generatedEvent, self._Party__updateLocalAvatarTeleportIn, [
                requestStatus])
    ...
    def _Party__updateLocalAvatarTeleportIn(self, requestStatus):
        ...
        if hasattr(base, 'distributedParty'):
            ...
            self.accept('generate-' + str(base.distributedParty.partyInfo.hostId), self._Party__setPartyHat)
    ...
    def enterTeleportOut(self, requestStatus):
        Place.Place.enterTeleportOut(self, requestStatus, self._Party__teleportOutDone)
