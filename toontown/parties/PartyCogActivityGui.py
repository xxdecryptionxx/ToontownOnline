...
class PartyCogTrackerGui:
    ...
    def __init__(self):
        ...
        for i in range(3):
            ...
            seq = Sequence(LerpScaleInterval(self.cogs[i], duration = 0.10000000000000001, scale = big, startScale = Point3(1.0, 1.0, 1.0), blendType = 'easeOut'), LerpScaleInterval(self.cogs[i], duration = 0.25, scale = Point3(1.0, 1.0, 1.0), startScale = big, blendType = 'easeOut'), Wait(0.40000000000000002))
