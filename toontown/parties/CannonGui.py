...
class CannonGui(DirectObject):
    ...
    def load(self):
        ...
        self._CannonGui__aimPad = DirectFrame(image = guiNode.find('**/CannonFire_PAD'), relief = None, pos = (0.69999999999999996, 0, -0.55333299999999996), scale = 0.80000000000000004)
        guiNode.removeNode()
        self.fireButton = DirectButton(parent = self._CannonGui__aimPad, image = ((guiModel, '**/Fire_Btn_UP'), (guiModel, '**/Fire_Btn_DN'), (guiModel, '**/Fire_Btn_RLVR')), relief = None, pos = (0.0115741, 0, 0.0050505100000000002), scale = 1.0, command = self._CannonGui__firePressed)
        self.upButton = DirectButton(parent = self._CannonGui__aimPad, image = ((guiModel, '**/Cannon_Arrow_UP'), (guiModel, '**/Cannon_Arrow_DN'), (guiModel, '**/Cannon_Arrow_RLVR')), relief = None, pos = (0.0115741, 0, 0.221717))
        self.downButton = DirectButton(parent = self._CannonGui__aimPad, image = ((guiModel, '**/Cannon_Arrow_UP'), (guiModel, '**/Cannon_Arrow_DN'), (guiModel, '**/Cannon_Arrow_RLVR')), relief = None, pos = (0.0136112, 0, -0.21010100000000001), image_hpr = (0, 0, 180))
        self.leftButton = DirectButton(parent = self._CannonGui__aimPad, image = ((guiModel, '**/Cannon_Arrow_UP'), (guiModel, '**/Cannon_Arrow_DN'), (guiModel, '**/Cannon_Arrow_RLVR')), relief = None, pos = (-0.199352, 0, -0.00050526900000000003), image_hpr = (0, 0, -90))
        self.rightButton = DirectButton(parent = self._CannonGui__aimPad, image = ((guiModel, '**/Cannon_Arrow_UP'), (guiModel, '**/Cannon_Arrow_DN'), (guiModel, '**/Cannon_Arrow_RLVR')), relief = None, pos = (0.219167, 0, -0.0010102399999999999), image_hpr = (0, 0, 90))
        ...
        bindButton(self.upButton, self._CannonGui__upPressed, self._CannonGui__upReleased)
        bindButton(self.downButton, self._CannonGui__downPressed, self._CannonGui__downReleased)
        bindButton(self.leftButton, self._CannonGui__leftPressed, self._CannonGui__leftReleased)
        bindButton(self.rightButton, self._CannonGui__rightPressed, self._CannonGui__rightReleased)
    ...
    def _CannonGui__downPressed(self):
        ...
        self.downPressed = self._CannonGui__enterControlActive(self.downPressed)

    
    def _CannonGui__leftPressed(self):
        self.notify.debug('left pressed')
        self.leftPressed = self._CannonGui__enterControlActive(self.leftPressed)

    
    def _CannonGui__rightPressed(self):
        self.notify.debug('right pressed')
        self.rightPressed = self._CannonGui__enterControlActive(self.rightPressed)
    ...
    def _CannonGui__rightReleased(self):
        ...
        self.rightPressed = self._CannonGui__exitControlActive(self.rightPressed)
