...
class PartyCogActivityLocalPlayer(PartyCogActivityPlayer):
    ...
    def _initOrthoWalk(self):
        orthoDrive = OrthoDrive(9.7780000000000005, customCollisionCallback = self.activity.view.checkOrthoDriveCollision)
