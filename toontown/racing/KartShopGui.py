...
class KartShopGuiMgr(object, DirectObject.DirectObject):
    ...
    class MainMenuDlg(DirectFrame):
        ...
        def __init__(self, doneEvent):
            ...
            DirectFrame.__init__(self, relief = None, state = 'normal', geom = model, text_scale = 0.10000000000000001, geom_scale = self.modelScale, pos = (0, 0, -0.01), frameSize = (-1, 1, -1, 1))
            self.initialiseoptions(KartShopGuiMgr.MainMenuDlg)
            self.cancelButton = DirectButton(parent = self, relief = None, geom = model.find('**/CancelIcon'), image = (model.find('**/CancelButtonUp'), model.find('**/CancelButtonDown'), model.find('**/CancelButtonRollover')), scale = self.modelScale, pressEffect = False, command = lambda : messenger.send(doneEvent, [
MM_OPTIONS.Cancel]))
            self.buyKartButton = DirectButton(parent = self, relief = None, image = (model.find('**/BuyKartButtonUp'), model.find('**/BuyKartButtonDown'), model.find('**/BuyKartButtonRollover'), model.find('**/BuyKartButtonDisabled')), scale = self.modelScale, geom = model.find('**/BuyKartIcon'), text = TTLocalizer.KartShop_BuyKart, text_scale = KS_TEXT_SIZE_BIG, text_pos = (-0.20000000000000001, 0.34000000000000002), pressEffect = False, command = lambda : messenger.send(doneEvent, [
MM_OPTIONS.BuyKart]))
            self.buyAccessoryButton = DirectButton(parent = self, relief = None, image = (model.find('**/BuyAccessoryButtonUp'), model.find('**/BuyAccessoryButtonDown'), model.find('**/BuyAccessoryButtonRollover'), model.find('**/BuyAccessoryButtonDisabled')), geom = model.find('**/BuyAccessoryIcon'), image3_color = Vec4(0.59999999999999998, 0.59999999999999998, 0.59999999999999998, 1), scale = self.modelScale, text = TTLocalizer.KartShop_BuyAccessories, text_scale = KS_TEXT_SIZE_BIG, text_pos = (-0.10000000000000001, 0.035999999999999997), pressEffect = False, command = lambda : messenger.send(doneEvent, [
MM_OPTIONS.BuyAccessory]))
    ...
    class BuyKartDlg(DirectFrame):
        ...
        def __init__(self, doneEvent):
            ...
            self.ticketDisplay = DirectLabel(parent = self, relief = None, text = str(base.localAvatar.getTickets()), text_scale = KS_TEXT_SIZE_SMALL, text_fg = (0.94999999999999996, 0.94999999999999996, 0.0, 1.0), text_shadow = (0, 0, 0, 1), text_pos = (0.44, -0.55000000000000004), text_font = ToontownGlobals.getSignFont())
            self.buyKartButton = DirectButton(parent = self, relief = None, image = (model.find('**/BuyKartButtonUp'), model.find('**/BuyKartButtonDown'), model.find('**/BuyKartButtonRollover'), model.find('**/BuyKartButtonDisabled')), scale = self.modelScale, text = TTLocalizer.KartShop_BuyKart, text_scale = KS_TEXT_SIZE_BIG, text_pos = (0, -0.53400000000000003), pressEffect = False, command = lambda : messenger.send(doneEvent, [
self.unownedKartList[self.curKart]]))
            self.cancelButton = DirectButton(parent = self, relief = None, image = (model.find('**/CancelButtonUp'), model.find('**/CancelButtonDown'), model.find('**/CancelButtonRollover')), geom = model.find('**/CancelIcon'), scale = self.modelScale, pressEffect = False, command = lambda : messenger.send(doneEvent, [
BK_OPTIONS.Cancel]))
            self.arrowLeftButton = DirectButton(parent = self, relief = None, image = (model.find('**/ArrowLeftButtonUp'), model.find('**/ArrowLeftButtonDown'), model.find('**/ArrowLeftButtonRollover'), model.find('**/ArrowLeftButtonInactive')), scale = self.modelScale, pressEffect = False, command = self._BuyKartDlg__handleKartChange, extraArgs = [
                -1])
            self.arrowRightButton = DirectButton(parent = self, relief = None, image = (model.find('**/ArrowRightButtonUp'), model.find('**/ArrowRightButtonDown'), model.find('**/ArrowRightButtonRollover'), model.find('**/ArrowRightButtonInactive')), scale = self.modelScale, pressEffect = False, command = self._BuyKartDlg__handleKartChange, extraArgs = [
                1])
            ...
            self.kartView.setBounds(-0.38, 0.38, 0.0035000000000000001, 0.53000000000000003)
        ...
        def showKart(self):
            ...
            if self.numKarts > 0:
                ...
                self.kartDescription = DirectButton(parent = self, relief = None, scale = self.modelScale, text = description, text_pos = (0, -0.28999999999999998), text_scale = KS_TEXT_SIZE_SMALL, pressEffect = False, textMayChange = True)
                self.kartCost = DirectButton(parent = self, relief = None, scale = self.modelScale, text = cost, text_pos = (0, -0.36499999999999999), text_scale = KS_TEXT_SIZE_SMALL, pressEffect = False, textMayChange = True)
                ...
                if info[KartInfo.cost] > base.localAvatar.getTickets():
                    ...
                    self.kartCost.configure(text_fg = (0.94999999999999996, 0, 0.0, 1.0))
    ...
    class ReturnKartDlg(DirectFrame):
        ...
        def __init__(self, doneEvent):
            ...
            DirectFrame.__init__(self, relief = None, state = 'normal', geom = model, geom_scale = self.modelScale, frameSize = (-1, 1, -1, 1), pos = (0, 0, -0.01), text = TTLocalizer.KartShop_ConfirmReturnKart, text_wordwrap = 11, text_scale = KS_TEXT_SIZE_SMALL * 0.90000000000000002, text_pos = (0, -0.26000000000000001))
            self.initialiseoptions(KartShopGuiMgr.ReturnKartDlg)
            self.cancelButton = DirectButton(parent = self, relief = None, image = (model.find('**/CancelButtonUp'), model.find('**/CancelButtonDown'), model.find('**/CancelButtonRollover')), geom = model.find('**/CancelIcon'), scale = self.modelScale, pressEffect = False, command = lambda : messenger.send(doneEvent, [
RK_OPTIONS.Cancel]))
            self.okButton = DirectButton(parent = self, relief = None, image = (model.find('**/CheckButtonUp'), model.find('**/CheckButtonDown'), model.find('**/CheckButtonRollover')), geom = model.find('**/CheckIcon'), scale = self.modelScale, pressEffect = False, command = lambda : messenger.send(doneEvent, [
RK_OPTIONS.ReturnKart]))
            ...
            self.kartView.setBounds(-0.38, 0.38, -0.040000000000000001, 0.48999999999999999)
            self.kartView.setBgColor(1.0, 1.0, 0.80000000000000004, 1.0)
            self.kartView.show()
            model.removeNode()
            self.initialize = True
    ...
    class BoughtKartDlg(DirectFrame):
        ...
        def __init__(self, doneEvent, kartID):
            ...
            DirectFrame.__init__(self, relief = None, state = 'normal', geom = model, geom_scale = self.modelScale, frameSize = (-1, 1, -1, 1), pos = (0, 0, -0.01), text = TTLocalizer.KartShop_ConfirmBoughtTitle, text_wordwrap = 26, text_scale = KS_TEXT_SIZE_SMALL, text_pos = (0, -0.26000000000000001))
            self.initialiseoptions(KartShopGuiMgr.BoughtKartDlg)
            self.ticketDisplay = DirectLabel(parent = self, relief = None, text = str(base.localAvatar.getTickets()), text_scale = KS_TEXT_SIZE_SMALL, text_fg = (0.94999999999999996, 0.94999999999999996, 0.0, 1.0), text_shadow = (0, 0, 0, 1), text_pos = (0.42999999999999999, -0.5), text_font = ToontownGlobals.getSignFont())
            self.okButton = DirectButton(parent = self, relief = None, image = (model.find('**/CheckButtonUp'), model.find('**/CheckButtonDown'), model.find('**/CheckButtonRollover')), geom = model.find('**/CheckIcon'), scale = self.modelScale, pressEffect = False, command = lambda : messenger.send(doneEvent, [
BTK_OPTIONS.Ok]))
            self.kartView = KartViewer([
                kartID,
            ...
            self.kartView.setPos(model.find('**/KartViewerFrame').getPos())
            self.kartView.load(model, 'KartViewerFrame', [], [])
            self.kartView.setBounds(-0.38, 0.38, -0.042500000000000003, 0.48999999999999999)
            self.kartView.setBgColor(1.0, 1.0, 0.80000000000000004, 1.0)
            self.kartView.show()
            model.removeNode()
            self.initialize = True
    ...
    class ConfirmBuyKartDlg(DirectFrame):
        ...
        def __init__(self, doneEvent, kartNum):
            ...
            DirectFrame.__init__(self, relief = None, state = 'normal', geom = model, geom_scale = self.modelScale, frameSize = (-1, 1, -1, 1), pos = (0, 0, -0.01), text = TTLocalizer.KartShop_ConfirmBuy % (name, cost), text_wordwrap = 11, text_scale = KS_TEXT_SIZE_SMALL, text_pos = (0, -0.26000000000000001))
...
CBK_OPTIONS.BuyKart]))
    ...
    class BuyAccessoryDlg(DirectFrame):
        ...
        def __init__(self, doneEvent):
            ...
            DirectFrame.__init__(self, relief = None, state = 'normal', geom = model, geom_scale = self.modelScale, frameSize = (-1, 1, -1, 1), pos = (0, 0, -0.01), text_wordwrap = 26, text_scale = 0.10000000000000001, text_fg = Vec4(0.35999999999999999, 0.93999999999999995, 0.93000000000000005, 1.0), text_pos = (0, 0))
            self.initialiseoptions(KartShopGuiMgr.BuyAccessoryDlg)
            self.ticketDisplay = DirectLabel(parent = self, relief = None, text = str(base.localAvatar.getTickets()), text_scale = KS_TEXT_SIZE_SMALL, text_fg = (0.94999999999999996, 0.94999999999999996, 0.0, 1.0), text_shadow = (0, 0, 0, 1), text_pos = (0.41999999999999998, -0.59999999999999998), text_font = ToontownGlobals.getSignFont())
            self.arrowLeftButton = DirectButton(parent = self, relief = None, image = (model.find('**/ArrowLeftButtonUp'), model.find('**/ArrowLeftButtonDown'), model.find('**/ArrowLeftButtonRollover'), model.find('**/ArrowLeftButtonInactive')), scale = self.modelScale, text_pos = (0, 0), text_scale = 0.10000000000000001, pressEffect = False, command = self._BuyAccessoryDlg__handleAccessoryChange, extraArgs = [
                -1])
            self.arrowRightButton = DirectButton(parent = self, relief = None, image = (model.find('**/ArrowRightButtonUp'), model.find('**/ArrowRightButtonDown'), model.find('**/ArrowRightButtonRollover'), model.find('**/ArrowRightButtonInactive')), scale = self.modelScale, text_pos = (0, 0), text_scale = 0.10000000000000001, pressEffect = False, command = self._BuyAccessoryDlg__handleAccessoryChange, extraArgs = [
                1])
            self.cancelButton = DirectButton(parent = self, relief = None, image = (model.find('**/CancelButtonUp'), model.find('**/CancelButtonDown'), model.find('**/CancelButtonRollover')), geom = model.find('**/CancelIcon'), scale = self.modelScale, command = lambda : messenger.send(doneEvent, [
BA_OPTIONS.Cancel]), pressEffect = False)
            self.decalAccButton = DirectButton(parent = self, relief = None, image = (model.find('**/DecalButtonUp'), model.find('**/DecalButtonDown'), model.find('**/DecalButtonRollover'), model.find('**/DecalButtonDown')), scale = self.modelScale, pressEffect = False, command = self._BuyAccessoryDlg__handleAccessoryTypeChange, extraArgs = [
                KartDNA.decalType])
            self.spoilerAccButton = DirectButton(parent = self, relief = None, image = (model.find('**/SpoilerButtonUp'), model.find('**/SpoilerButtonDown'), model.find('**/SpoilerButtonRollover'), model.find('**/SpoilerButtonDown')), scale = self.modelScale, pressEffect = False, command = self._BuyAccessoryDlg__handleAccessoryTypeChange, extraArgs = [
                KartDNA.spType])
            self.eBlockAccButton = DirectButton(parent = self, relief = None, image = (model.find('**/EBlockButtonUp'), model.find('**/EBlockButtonDown'), model.find('**/EBlockButtonRollover'), model.find('**/EBlockButtonDown')), scale = self.modelScale, pressEffect = False, command = self._BuyAccessoryDlg__handleAccessoryTypeChange, extraArgs = [
                KartDNA.ebType])
            self.rearAccButton = DirectButton(parent = self, relief = None, image = (model.find('**/RearButtonUp'), model.find('**/RearButtonDown'), model.find('**/RearButtonRollover'), model.find('**/RearButtonDown')), scale = self.modelScale, pressEffect = False, command = self._BuyAccessoryDlg__handleAccessoryTypeChange, extraArgs = [
                KartDNA.bwwType])
            self.frontAccButton = DirectButton(parent = self, relief = None, image = (model.find('**/FrontButtonUp'), model.find('**/FrontButtonDown'), model.find('**/FrontButtonRollover'), model.find('**/FrontButtonDown')), scale = self.modelScale, text_pos = (0, 0), text_scale = 0.10000000000000001, pressEffect = False, command = self._BuyAccessoryDlg__handleAccessoryTypeChange, extraArgs = [
                KartDNA.fwwType])
            self.rimAccButton = DirectButton(parent = self, relief = None, image = (model.find('**/RimButtonUp'), model.find('**/RimButtonDown'), model.find('**/RimButtonRollover'), model.find('**/RimButtonDown')), scale = self.modelScale, pressEffect = False, command = self._BuyAccessoryDlg__handleAccessoryTypeChange, extraArgs = [
                KartDNA.rimsType])
            self.paintAccButton = DirectButton(parent = self, relief = None, image = (model.find('**/PaintButtonUp'), model.find('**/PaintButtonDown'), model.find('**/PaintButtonRollover'), model.find('**/PaintButtonDown')), scale = self.modelScale, pressEffect = False, command = self._BuyAccessoryDlg__handleAccessoryTypeChange, extraArgs = [
                KartDNA.bodyColor])
            self.accButtonsDict = {
            ...
            self.buyAccessoryButton = DirectButton(parent = self, relief = None, image = (model.find('**/BuyAccessoryButtonUp'), model.find('**/BuyAccessoryButtonDown'), model.find('**/BuyAccessoryButtonRollover'), model.find('**/BuyAccessoryButtonDisabled')), scale = self.modelScale, text = TTLocalizer.KartShop_BuyAccessory, text_pos = (0, -0.56999999999999995), text_scale = KS_TEXT_SIZE_SMALL, pressEffect = False, command = self._BuyAccessoryDlg__handleBuyAccessory)
            ...
            self.kartView.setBounds(-0.38, 0.38, 0.043999999999999997, 0.57999999999999996)
        ...
        def showAccessory(self):
            ...
            self.arrowLeftButton['state'] = DGG.DISABLED
            self.buyAccessoryButton['state'] = DGG.DISABLED
            self.accDescription = DirectButton(parent = self, relief = None, scale = self.modelScale, text = '', text_pos = (0, -0.33000000000000002), text_scale = KS_TEXT_SIZE_SMALL, pressEffect = False, text_wordwrap = TTLocalizer.KSGaccDescriptionWordwrap, textMayChange = True)
            ...
            self.accCost = DirectButton(parent = self, relief = None, scale = self.modelScale, text = cost, text_pos = (0, -0.40000000000000002), text_scale = KS_TEXT_SIZE_SMALL, text_fg = (0, 0, 0.0, 1.0), pressEffect = False, textMayChange = True)
            if AccessoryDict[curAcc][KartInfo.cost] > base.localAvatar.getTickets():
                ...
                self.accCost.configure(text_fg = (0.94999999999999996, 0, 0.0, 1.0))
            
            if len(base.localAvatar.getKartAccessoriesOwned()) >= KartShopGlobals.MAX_KART_ACC:
                self.buyAccessoryButton['state'] = DGG.DISABLED
                self.buyAccessoryButton.configure(text_fg = (0.94999999999999996, 0, 0.0, 1.0))
                self.buyAccessoryButton.configure(text_scale = KS_TEXT_SIZE_SMALL * 0.80000000000000004)
    ...
    class BoughtAccessoryDlg(DirectFrame):
        ...
        def __init__(self, doneEvent, accID):
            ...
            DirectFrame.__init__(self, relief = None, state = 'normal', geom = model, geom_scale = self.modelScale, frameSize = (-1, 1, -1, 1), pos = (0, 0, -0.01), text = TTLocalizer.KartShop_ConfirmBoughtTitle, text_wordwrap = 26, text_scale = KS_TEXT_SIZE_SMALL, text_pos = (0, -0.28000000000000003))
...
BTA_OPTIONS.Ok]))
            ...
            self.kartView.component('geom0').setColorScale(1.0, 1.0, 0.80000000000000004, 1.0)
...
CBA_OPTIONS.BuyAccessory]))
    ...
    def __init__(self, eventDict):
        ...
        self.dialogEventDict = {
            MENUS.MainMenu: ('MainMenuGuiDone', self._KartShopGuiMgr__handleMainMenuDlg, self.MainMenuDlg),
            MENUS.BuyKart: ('BuyKartGuiDone', self._KartShopGuiMgr__handleBuyKartDlg, self.BuyKartDlg),
            MENUS.BuyAccessory: ('BuyAccessoryGuiDone', self._KartShopGuiMgr__handleBuyAccessoryDlg, self.BuyAccessoryDlg),
            MENUS.ReturnKart: ('ReturnKartGuiDone', self._KartShopGuiMgr__handleReturnKartDlg, self.ReturnKartDlg),
            MENUS.ConfirmBuyKart: ('ConfirmBuyKartGuiDone', self._KartShopGuiMgr__handleConfirmBuyKartDlg, self.ConfirmBuyKartDlg),
            MENUS.ConfirmBuyAccessory: ('ConfirmBuyAccessoryGuiDone', self._KartShopGuiMgr__handleConfirmBuyAccessoryDlg, self.ConfirmBuyAccessoryDlg),
            MENUS.BoughtKart: ('BoughtKartGuiDone', self._KartShopGuiMgr__handleBoughtKartDlg, self.BoughtKartDlg),
            MENUS.BoughtAccessory: ('BoughtAccessoryGuiDone', self._KartShopGuiMgr__handleBoughtAccessoryDlg, self.BoughtAccessoryDlg),
            MENUS.TeaserPanel: ('UnpaidPurchaseAttempt', self._KartShopGuiMgr__handleTeaserPanelDlg, TeaserPanel) }
        self.kartID = -1
        self.accID = -1
        self.timer = ToontownTimer.ToontownTimer()
        self.timer.reparentTo(aspect2d)
        self.timer.posInTopRightCorner()
        self.timer.accept('RESET_KARTSHOP_TIMER', self._KartShopGuiMgr__resetTimer)
        self.timer.countdown(KartShopGlobals.KARTCLERK_TIMER, self._KartShopGuiMgr__timerExpired)
    ...
    def _KartShopGuiMgr__doDialog(self, dialogType):
        ...
        if dialogType == MENUS.ConfirmBuyKart:
            ...
            self.dialog = eventDlg(pageName = 'karting', doneFunc = self._KartShopGuiMgr__doLastMenu)
        else:
        ...
        if __name__ == '__main__':
            ...
            class Main(DirectObject.DirectObject):
                ...
                def __init__(self):
                    ...
                    self.accept(KartShopGlobals.EVENTDICT['buyAccessory'], self._Main__handleBuyAccessory)
                    self.accept(KartShopGlobals.EVENTDICT['buyKart'], self._Main__handleBuyKart)

                
                def _Main__popupKartShopGui(self):
                    if not hasattr(self, 'kartShopGui') or self.kartShopGui == None:
                        self.acceptOnce(KartShopGlobals.EVENTDICT['guiDone'], self._Main__handleGuiDone)
