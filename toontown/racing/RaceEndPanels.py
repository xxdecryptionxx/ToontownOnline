...
class RaceResultsPanel(DirectFrame):
    ...
    def __init__(self, numRacers, race, raceEndPanel, *args, **kwargs):
        ...
        self.pointsLabel = DirectLabel(parent = self, relief = None, pos = (0.69999999999999996, 0, 0.29999999999999999), text = TTLocalizer.KartRace_CircuitPoints, text_fg = (0.0, 0.0, 0.0, 1.0), text_scale = TTLocalizer.REPsmallLabel)
        ...
        for x in range(self.numRacers):
            ...
            fFrame = DirectFrame(parent = frame, relief = None, pos = (0.10000000000000001, -0.01, 0.01))
            nLabel = DirectLabel(parent = frame, relief = None, pos = (0.46000000000000002, 0.0, 0.0), text = '', text_fg = (0.0, 0.0, 0.0, 1.0), text_scale = TTLocalizer.REPsmallLabel, text_align = TextNode.ACenter, text_font = DGG.getDefaultFont())
            tLabel = DirectLabel(parent = frame, relief = None, pos = (0.90000000000000002, 0.0, 0.0), text = "--'--''--", text_fg = (0.5, 0.5, 0.5, 1.0), text_scale = TTLocalizer.REPsmallLabel, text_font = DGG.getDefaultFont())
            wLabel = DirectLabel(parent = frame, relief = None, pos = (1.1399999999999999, 0.0, 0.0), text = '', text_fg = (0, 0, 0, 1), text_scale = TTLocalizer.REPsmallLabel, text_align = TextNode.ALeft, text_font = DGG.getDefaultFont())
            cpLabel = DirectLabel(parent = frame, relief = None, pos = (1.3999999999999999, 0.0, 0.0), text = '', text_fg = (0, 0, 0, 1), text_scale = TTLocalizer.REPsmallLabel, text_align = TextNode.ALeft, text_font = DGG.getDefaultFont())
            ncpLabel = DirectLabel(parent = frame, relief = None, pos = (1.4399999999999999, 0.0, 0.0), text = '', text_fg = (1, 0, 0, 1), text_scale = TTLocalizer.REPsmallLabel, text_align = TextNode.ALeft, text_font = DGG.getDefaultFont())
            self.entryList.append((pLabel, fFrame, nLabel, tLabel, wLabel, cpLabel, ncpLabel))
        

    
    def getRowPos(self, place):
        return Point3(-0.71999999999999997, -0.01, 0.25 - place * 0.17999999999999999)
    ...
    def displayRacer(self, place, headFrame, name, time, qualify, tickets, bonus, trophies, circuitPoints, circuitTime):
        ...
        def flipText(flip, label = self.entryList[place - 1][3], timeStr = timeStr, recStr = TTLocalizer.KartRace_Record):
            self.entryList[place - 1][3].configure(text_scale = 0.059999999999999998)
            self.entryList[place - 1][3].configure(text_fg = (0.94999999999999996, 0.0, 0.0, 1.0))
            if flip:
...
class RaceWinningsPanel(DirectFrame):
    ...
    def __init__(self, race, *args, **kwargs):
        ...
        tLabel = DirectLabel(parent = tFrame, relief = None, pos = (0.0, 0.0, 0.25), text = TTLocalizer.KartRace_Tickets, text_fg = (0.0, 0.0, 0.0, 1.0), text_scale = 0.10000000000000001, text_font = DGG.getDefaultFont())
        DirectLabel(parent = tFrame, relief = None, pos = (TTLocalizer.REPtextPosX, 0.0, 0.10000000000000001), text = TTLocalizer.KartRace_Deposit + TTLocalizer.KartRace_Colon, text_fg = (0.0, 0.0, 0.0, 1.0), text_scale = TTLocalizer.REPlargeLabel, text_align = TextNode.ALeft, text_font = DGG.getDefaultFont())
        dLabel = DirectLabel(parent = tFrame, relief = None, pos = (0.050000000000000003, 0.0, 0.10000000000000001), text = TTLocalizer.KartRace_Zero, text_fg = (0.0, 0.0, 0.0, 1.0), text_scale = TTLocalizer.REPlargeLabel, text_align = TextNode.ARight, text_font = DGG.getDefaultFont())
        ...
        wLabel = DirectLabel(parent = tFrame, relief = None, pos = (0.050000000000000003, 0.0, 0.0), text = TTLocalizer.KartRace_Zero, text_fg = (0.0, 0.0, 0.0, 1.0), text_scale = TTLocalizer.REPlargeLabel, text_align = TextNode.ARight, text_font = DGG.getDefaultFont())
        DirectLabel(parent = tFrame, relief = None, pos = (TTLocalizer.REPtextPosX, 0.0, -0.10000000000000001), text = TTLocalizer.KartRace_Bonus + TTLocalizer.KartRace_Colon, text_fg = (0.0, 0.0, 0.0, 1.0), text_scale = TTLocalizer.REPlargeLabel, text_align = TextNode.ALeft, text_font = DGG.getDefaultFont())
        bLabel = DirectLabel(parent = tFrame, relief = None, pos = (0.050000000000000003, 0.0, -0.10000000000000001), text = TTLocalizer.KartRace_Zero, text_fg = (0.0, 0.0, 0.0, 1.0), text_scale = TTLocalizer.REPlargeLabel, text_align = TextNode.ARight, text_font = DGG.getDefaultFont())
        self.raceTotalLabel = DirectLabel(parent = tFrame, relief = None, pos = (TTLocalizer.REPtextPosX, 0.0, -0.20000000000000001), text = TTLocalizer.KartRace_RaceTotal + TTLocalizer.KartRace_Colon, text_fg = (0.0, 0.0, 0.0, 1.0), text_scale = TTLocalizer.REPlargeLabel, text_align = TextNode.ALeft, text_font = DGG.getDefaultFont())
        self.circuitTotalLabel = DirectLabel(parent = tFrame, relief = None, pos = (TTLocalizer.REPtextPosX, 0.0, -0.20000000000000001), text = TTLocalizer.KartRace_CircuitTotal + TTLocalizer.KartRace_Colon, text_fg = (0.0, 0.0, 0.0, 1.0), text_scale = TTLocalizer.REPlargeLabel, text_align = TextNode.ALeft, text_font = DGG.getDefaultFont())
        self.doubleTicketsLabel = DirectLabel(parent = tFrame, relief = None, pos = (0.5, 0.0, -0.26000000000000001), text = TTLocalizer.KartRace_DoubleTickets, text_fg = (1.0, 0.125, 0.125, 1.0), text_scale = TTLocalizer.REPlargeLabel, text_align = TextNode.ACenter, text_shadow = (0, 0, 0, 1), text_font = DGG.getDefaultFont())
        fLabel = DirectLabel(parent = tFrame, relief = None, pos = (0.050000000000000003, 0.0, -0.20000000000000001), text = TTLocalizer.KartRace_Zero, text_fg = (0.0, 0.0, 0.0, 1.0), text_scale = TTLocalizer.REPlargeLabel, text_align = TextNode.ARight, text_font = DGG.getDefaultFont())
        ticketPic = DirectFrame(parent = tFrame, relief = None, image = loader.loadModel('phase_6/models/karting/tickets'), image_pos = (0.5, 0, -0.02), image_scale = 0.40000000000000002)
        self.ticketFrame = tFrame
        self.ticketComponents = (dLabel, wLabel, bLabel, fLabel)
        tFrame = DirectFrame(parent = frame, relief = None, pos = (0, 0, 0))
        tLabel = DirectLabel(parent = tFrame, relief = None, pos = (0.0, 0.0, 0.25), text = TTLocalizer.KartRace_Bonus, text_fg = (0.0, 0.0, 0.0, 1.0), text_scale = 0.10000000000000001, text_font = DGG.getDefaultFont())
        textFrame = DirectFrame(parent = tFrame, relief = None, text = '', text_scale = TTLocalizer.REPlargeLabel, text_font = DGG.getDefaultFont(), text_pos = (-0.29999999999999999, 0.10000000000000001, 0))
        bonusPic = DirectFrame(parent = tFrame, relief = None, image = loader.loadModel('phase_6/models/karting/tickets'), image_pos = (0.5, 0, -0.02), image_scale = 0.40000000000000002)
        self.bonusFrame = tFrame
        self.bonusComponents = (textFrame, bonusPic)
        tFrame = DirectFrame(parent = frame, relief = None, pos = (0, 0, 0))
        tLabel = DirectLabel(parent = tFrame, relief = None, pos = (0.0, 0.0, 0.25), text = TTLocalizer.KartRace_Trophies, text_fg = (0.0, 0.0, 0.0, 1.0), text_scale = 0.10000000000000001, text_font = DGG.getDefaultFont())
        textFrame = DirectFrame(parent = tFrame, relief = None, text = '', text_scale = TTLocalizer.REPlargeLabel, text_font = DGG.getDefaultFont(), text_pos = (-0.29999999999999999, 0.10000000000000001, 0))
    ...
    def generateDisplaySequences(self, track, ticDeposit, ticWon, ticBonus, trophies, endOfCircuitRace = False):
        ...
        if not origTicBonus or [
            1]:
            pass
        ticketSeq.append(Sequence(Func(self.bonusFrame.hide), Func(self.trophyFrame.hide), Func(self.ticketFrame.show), Func(self.ticketComponents[3].configure, text_color = Vec4(0, 0, 0, 1)), Func(self.ticketComponents[0].configure, text_color = Vec4(1, 0, 0, 1)), Parallel(LerpFunc(ticketTicker, duration = [
            0][0], extraArgs = [
            self.ticketComponents[0],
            0,
            ticDeposit]), LerpFunc(ticketTicker, duration = [
            0][0], extraArgs = [
            self.ticketComponents[3],
            0,
            ticDeposit])), Func(self.ticketComponents[0].configure, text_color = Vec4(0, 0, 0, 1)), Func(self.ticketComponents[1].configure, text_color = Vec4(1, 0, 0, 1)), Parallel(LerpFunc(ticketTicker, duration = [
            0][0], extraArgs = [
            self.ticketComponents[1],
            0,
            ticWon]), LerpFunc(ticketTicker, duration = [
            0][0], extraArgs = [
            self.ticketComponents[3],
            ticDeposit,
            ticDeposit + ticWon])), Func(self.ticketComponents[1].configure, text_color = Vec4(0, 0, 0, 1)), Func(self.ticketComponents[2].configure, text_color = Vec4(1, 0, 0, 1)), Parallel(LerpFunc(ticketTicker, duration = [
            0][0], extraArgs = [
            self.ticketComponents[2],
            0,
            origTicBonus]), LerpFunc(ticketTicker, duration = [
            0][0], extraArgs = [
            self.ticketComponents[3],
            ticDeposit + ticWon,
            ticDeposit + ticWon + origTicBonus])), Func(self.ticketComponents[2].configure, text_color = Vec4(0, 0, 0, 1)), Func(self.ticketComponents[3].configure, text_color = Vec4(1, 0, 0, 1))))
...
class RaceEndPanel(DirectFrame):
    ...
    def __init__(self, numRacers, race, *args, **kwargs):
        ...
        self.enabled = False
        self.race = race
        self.results = RaceResultsPanel(numRacers, race, self, parent = self, pos = (0, 0, 0.52500000000000002))
        self.winnings = RaceWinningsPanel(race, parent = self, pos = (0, 0, -0.52500000000000002))
        if len(self.race.circuitLoop) == 0:
            exitText = TTLocalizer.KartRace_Exit
        else:
            exitText = TTLocalizer.KartRace_NextRace
        gui = loader.loadModel('phase_3.5/models/gui/avatar_panel_gui')
        self.closeButton = DirectButton(parent = self, image = (gui.find('**/CloseBtn_UP'), gui.find('**/CloseBtn_DN'), gui.find('**/CloseBtn_Rllvr'), gui.find('**/CloseBtn_UP')), relief = None, scale = 2.0, text = exitText, text_scale = TTLocalizer.REPsmallLabel, text_pos = (0, -0.10000000000000001), text_fg = VBase4(1, 1, 1, 1), pos = (1.1000000000000001, 0, -0.5), command = self.closeButtonPressed)
