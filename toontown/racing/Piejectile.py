...
class Piejectile(DirectObject, FlyingGag):
    ...
    def setupPhysics(self):
        ...
        taskMgr.add(self._Piejectile__updatePhysics, self.taskName, priority = 25)
    ...
    def _Piejectile__updatePhysics(self, task):
        ...
        self.windResistance.setCoef(0.20000000000000001 + 0.80000000000000004 * self.timeRatio)
