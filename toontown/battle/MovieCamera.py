...
def avatarCloseUpThreeQuarterRightShotWide(avatar, duration):
    return heldRelativeShot(avatar, 7.2000000000000002, 8.4499999999999993, avatar.getHeight() * 0.66000000000000003, 131.5, 3.6000000000000001, 0, duration, 'avatarCloseUpThreeQuarterRightShot')
...
def avatarSideFollowAttack(suit, toon, duration, battle):
    windupDuration = duration * (0.10000000000000001 + random.random() * 0.10000000000000001)
...
def randomCameraSelection(suit, attack, attackDuration, openShotDuration):
    ...
    closeShotDuration = attackDuration - openShotDuration
    openShot = apply(random.choice(shotChoices), [
        suit,
        openShotDuration])
...
def avatarCloseUpFireShot(avatar, duration):
    return heldRelativeShot(avatar, 7, 17, avatar.getHeight() * 0.66000000000000003, 159, 3.6000000000000001, 0, duration, 'avatarCloseUpFireShot')


def avatarCloseUpThreeQuarterLeftFireShot(avatar, duration):
    return heldRelativeShot(avatar, -8.1999999999999993, 8.4499999999999993, avatar.getHeight() * 0.66000000000000003, -131.5, 3.6000000000000001, 0, duration, 'avatarCloseUpThreeQuarterLeftShot')
