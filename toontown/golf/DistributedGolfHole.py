...
class DistributedGolfHole(DistributedPhysicsWorld.DistributedPhysicsWorld, FSM, GolfHoleBase.GolfHoleBase):
    ...
    def __init__(self, cr):
        ...
        self._DistributedGolfHole__textGen.setFont(ToontownGlobals.getSignFont())
        ...
        if TTLocalizer.getLanguage() in [
            ...
            'portuguese',
            'french']:
            self._DistributedGolfHole__textGen.setGlyphScale(0.69999999999999996)
    ...
    def sendSwingInfo(self):
        ...
        if self.power < 15 and self.golfCourse.scores[localAvatar.doId][self.golfCourse.curHoleIndex] == 0:
            self.powerReminder = DirectLabel(text = TTLocalizer.GolfPowerReminder, text_shadow = (0, 0, 0, 1), text_fg = VBase4(1, 1, 0.0, 1), text_align = TextNode.ACenter, relief = None, pos = (0, 0, 0.80000000000000004), scale = 0.12)
    ...
    def updateWarning(self):
        ...
        if self.localMissedSwings == GolfGlobals.KICKOUT_SWINGS - 1:
            self.warningLabel = DirectLabel(parent = aspect2d, relief = None, pos = (0, 0, 0), text_align = TextNode.ACenter, text = TTLocalizer.GolfWarningMustSwing, text_scale = 0.12, text_font = ToontownGlobals.getSignFont(), text_fg = (1, 0.10000000000000001, 0.10000000000000001, 1), text_wordwrap = 20)
    ...
    def enterAim(self):
        ...
        self.aimInstructions = DirectLabel(text = TTLocalizer.GolfAimInstructions, text_shadow = (0, 0, 0, 1), text_fg = VBase4(1, 1, 1, 1), text_align = TextNode.ACenter, relief = None, pos = (0, 0, -0.80000000000000004), scale = TTLocalizer.DGHaimInstructions)
        self.skyContact = 1
        self.localToonHitControl = False
        self._adjustCamera()
    ...
    def handleBallGoingInHole(self):
        ...
        perfectTextSubnode = hidden.attachNewNode(self._DistributedGolfHole__genText(textStr))
    ...
    def readyCurrentGolfer(self, avId):
        ...
        if avId:
            ...
            if avId in self.ballDict:
                ...
                self.ballDict[avId]['golfBallOdeGeom'].setCategoryBits(BitMask32(0xFF000000L))
    ...
    def _DistributedGolfHole__beginTossGolf(self):
        ...
        self.scoreBoard.hide()
        taskMgr.add(self._DistributedGolfHole__updateGolfPower, self.golfPowerTaskName)
    ...
    def _DistributedGolfHole__updateGolfPower(self, task):
        ...
        newPower = self._DistributedGolfHole__getGolfPower(globalClock.getFrameTime())
        self.power = newPower
    ...
    def doFlyOverMovie(self, avId):
        ...
        self.titleLabel = DirectLabel(parent = aspect2d, relief = None, pos = (0, 0, 0.80000000000000004), text_align = TextNode.ACenter, text = title, text_scale = 0.12, text_font = ToontownGlobals.getSignFont(), text_fg = (1, 0.80000000000000004, 0.40000000000000002, 1))
