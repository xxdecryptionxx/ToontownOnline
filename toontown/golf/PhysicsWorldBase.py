...
class PhysicsWorldBase:
    ...
    def setupSimulation(self):
        ...
        self.world.setSurfaceEntry(0, 0, 150, 0.050000000000000003, 0.10000000000000001, 0.90000000000000002, 1.0000000000000001e-005, 0.0, 0.40000000000000002 / self.refCon)
        self.world.setSurfaceEntry(1, 1, 1500, 0.050000000000000003, 0.10000000000000001, 0.90000000000000002, 1.0000000000000001e-005, 0.0, 0.001 / self.refCon)
        self.world.setSurfaceEntry(2, 2, 150, 0.050000000000000003, 0.10000000000000001, 0.90000000000000002, 1.0000000000000001e-005, 0.0, 0.40000000000000002 / self.refCon)
        self.world.setSurfaceEntry(0, 2, 150, 0.050000000000000003, 0.10000000000000001, 0.90000000000000002, 1.0000000000000001e-005, 0.0, 0.40000000000000002 / self.refCon)
        self.world.setSurfaceEntry(0, 3, 150, 0.0, 0.10000000000000001, 0.90000000000000002, 1.0000000000000001e-005, 0.0, 0.40000000000000002 / self.refCon)
        self.world.setSurfaceEntry(1, 3, 150, 0.0, 99.099999999999994, 0.90000000000000002, 1.0000000000000001e-005, 0.0, 1.0 / self.refCon)
        self.world.setSurfaceEntry(2, 3, 150, 0.0, 9.0999999999999996, 0.90000000000000002, 1.0000000000000001e-005, 0.0, 0.40000000000000002 / self.refCon)
        self.world.setSurfaceEntry(3, 3, 150, 0.0, 9.0999999999999996, 0.90000000000000002, 1.0000000000000001e-005, 0.0, 0.40000000000000002 / self.refCon)
        self.world.setSurfaceEntry(4, 4, 150, 0.0, 9.0999999999999996, 0.90000000000000002, 1.0000000000000001e-005, 0.0, 0.40000000000000002 / self.refCon)
        self.world.setSurfaceEntry(1, 4, 150, 0.0, 99.099999999999994, 0.90000000000000002, 1.0000000000000001e-005, 0.0, 0.001 / self.refCon)
        self.world.setSurfaceEntry(pos1 = 0, pos2 = 1, mu = 80, bounce = 0.14999999999999999, bounce_vel = 0.10000000000000001, soft_erp = 0.90000000000000002, soft_cfm = 1.0000000000000001e-005, slip = 0.0, dampen = 0.34999999999999998 / self.refCon)
        self.world.setSurfaceEntry(pos1 = 2, pos2 = 1, mu = 1500, bounce = 0.90000000000000002, bounce_vel = 0.01, soft_erp = 0.90000000000000002, soft_cfm = 1.0000000000000001e-005, slip = 0.0, dampen = 0.001 / self.refCon)
        ...
        for key in self.commonObjectDict:
            ...
            if entry[1] in [
                ...
                for index in range(len(timeData)):
                    if (index == len(timeData) - 1 or timeData[index] < time or timeData[index] < time) and timeData[index + 1] > time:
    ...
    def getCommonObjectData(self):
        ...
        for key in self.commonObjectDict:
            ...
            data = (objectPair[0], objectPair[1], pos3[0], pos3[1], pos3[2], quat4[0], quat4[1], quat4[2], quat4[3], anV3[0], anV3[1], anV3[2], lnV3[0], lnV3[1], lnV3[2])
    ...
    def createCommonObject(self, type, commonId, pos, hpr, sizeX = 0, sizeY = 0, moveDistance = 0):
        ...
        if type == 0:
            ...
            (model, cross) = self.createPinWheel(self.world, self.space, 10.0, 1.6000000000000001, 4.0, 0.59999999999999998, 5, 3.7000000000000002, 1.2, 1, millFan, (0, 0, 90), (-4.5999999999999996, -0.5, -0.25), 20)
            self.placerNode.setHpr(vHpr)
            self.placerNode.setPos(vPos)
            self.subPlacerNode.setPos(-1, 0, 0.0)
            motor = OdeHingeJoint(self.world)
    ...
    def createSphere(self, world, space, density, radius, ballIndex = None):
        ...
        if ballIndex == 1:
            ...
            geom.setCategoryBits(BitMask32(0xFF000000L))
        elif ballIndex == 2:
            self.notify.debug('2')
            geom.setCollideBits(BitMask32(16777215))
            geom.setCategoryBits(BitMask32(0xFF000000L))
            ...
            geom.setCollideBits(BitMask32(0xFFFFFFFFL))
            geom.setCategoryBits(BitMask32(0xFFFFFFFFL))
        geom.setBody(body)
