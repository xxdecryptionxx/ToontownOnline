...
class GolfHoleBase:
    ...
    def loadLevel(self):
        ...
        for index in range(grassData.getNumPaths()):
            ...
            terrainGeomOde.setCollideBits(BitMask32(0xF0000000L))
        ...
        cupGeom.setCollideBits(BitMask32(0xF0000000L))
        ...
        hardGeom.setCollideBits(BitMask32(0xF0000000L))
    ...
    def createRays(self):
        ...
        self.ballRay.setCategoryBits(BitMask32(0xFF000000L))
    ...
    def trackRecordBodyFlight(self, ball, cycleTime, power, startPos, dirX, dirY):
        ...
        hasPrinted = 0
        while (ball.isEnabled() or len(self.recording) < 2100) and self.comObjNeedPass or len(self.recording) < 10:
            ran = 1
    ...
    def postStep(self):
        ...
        for count in range(self.colCount):
            ...
            if c0 == GolfGlobals.OOB_RAY_COLLIDE_ID or c1 == GolfGlobals.OOB_RAY_COLLIDE_ID:
                ...
                if self.canRender:
                    if self.currentGolfer:
                        self.ballShadowDict[self.currentGolfer].setPos(x, y, z + 0.10000000000000001)
                    
                
                if c1 == GolfGlobals.GRASS_COLLIDE_ID or c1 == GolfGlobals.HARD_COLLIDE_ID:
                    if self.curGolfBall().getPosition()[2] < z + 0.20000000000000001:
            ...
            if c0 == GolfGlobals.GRASS_COLLIDE_ID and c1 == GolfGlobals.SKY_RAY_COLLIDE_ID:
                ...
                if self.curGolfBall().getPosition()[2] < z + 0.20000000000000001 and rayCount == 0:
            ...
            if self.doingRecording:
                if c0 == GolfGlobals.OOB_RAY_COLLIDE_ID or c1 == GolfGlobals.OOB_RAY_COLLIDE_ID:
                    ...
                    ballUndersideZ = self.curGolfBall().getPosition()[2] - 0.050000000000000003
        ...
        if rayCount == 0:
            ...
            self.inCount = 0
            if skyRayHitPos:
                self.curGolfBall().setPosition(skyRayHitPos[0], skyRayHitPos[1], skyRayHitPos[2] + 0.27000000000000002)
        ...
        if self.grayCount > self.backAmount and self.doingRecording:
            ...
            self.curGolfBall().setPosition(self.recording[self.greenIn][1], self.recording[self.greenIn][2], self.recording[self.greenIn][3] + 0.27000000000000002)
            ...
            if self.hasReset < 3 and self.llv:
                ...
                if self.lastSkyContactPoint:
                    self.curGolfBall().setPosition(self.lastSkyContactPoint[0], self.lastSkyContactPoint[1], self.lastSkyContactPoint[2] + 0.27000000000000002)
