...
class GolfRewardDialog:
    ...
    def setup(self, localAvId):
        self.rewardBoard = DirectFrame(parent = aspect2d, relief = None, geom = DGG.getDefaultDialogGeom(), geom_color = ToontownGlobals.GlobalDialogColor, geom_scale = (1.75, 1, 0.59999999999999998), pos = (0, 0, -0.59999999999999998))
        self.rewardLabel = DirectLabel(parent = self.rewardBoard, relief = None, pos = (-0, 0, 0), text_align = TextNode.ACenter, text = '', text_scale = 0.050000000000000003, text_wordwrap = 30)
        self.rankLabel = DirectLabel(parent = self.rewardBoard, relief = None, pos = (-0, 0, 0.17000000000000001), text_align = TextNode.ACenter, text = '', text_scale = 0.059999999999999998)
        self.trophyLabel = DirectLabel(parent = self.rewardBoard, relief = None, pos = (-0.69999999999999996, 0, 0.050000000000000003), text_align = TextNode.ALeft, text = '', text_scale = 0.059999999999999998, text_wordwrap = 20)
