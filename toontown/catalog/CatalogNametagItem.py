...
class CatalogNametagItem(CatalogItem.CatalogItem):
    ...
    def getPicture(self, avatar):
        ...
        nameTagDemo = DirectLabel(parent = frame, relief = None, pos = (0, 0, 0.23999999999999999), scale = 0.5, text = localAvatar.getName(), text_fg = (1.0, 1.0, 1.0, 1), text_shadow = (0, 0, 0, 1), text_font = inFont, text_wordwrap = 9)
