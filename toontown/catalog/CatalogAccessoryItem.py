...
class CatalogAccessoryItem(CatalogItem.CatalogItem):
    ...
    def requestPurchase(self, phone, callback):
        ...
        if avatar.isTrunkFull(accessoriesOnOrder):
            ...
            buttonCallback = PythonUtil.Functor(self._CatalogAccessoryItem__handleFullPurchaseDialog, phone, callback)
            if avatar.getMaxAccessories() == 0:
    ...
    def _CatalogAccessoryItem__handleFullPurchaseDialog(self, phone, callback, buttonValue):
        TTDialog = TTDialog
        import toontown.toontowngui
        self.requestPurchaseCleanup()
