...
class CatalogChatItem(CatalogItem.CatalogItem):
    ...
    def showMessagePickerOnAccept(self, mailbox, index, callback):
        ...
        self.messagePicker = CatalogChatItemPicker.CatalogChatItemPicker(self._CatalogChatItem__handlePickerOnAccept, self.customIndex)
        self.messagePicker.show()

    
    def _CatalogChatItem__handlePickerOnAccept(self, status, pickedMessage = None):
