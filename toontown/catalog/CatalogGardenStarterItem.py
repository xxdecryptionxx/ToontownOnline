...
class CatalogGardenStarterItem(CatalogItem.CatalogItem):
    ...
    def reachedPurchaseLimit(self, avatar):
        if (self in avatar.onOrder and self in avatar.mailboxContents and self in avatar.onGiftOrder and self in avatar.awardMailboxContents and self in avatar.onAwardOrder or hasattr(avatar, 'gardenStarted')) and avatar.getGardenStarted():
            return 1
