...
class DistributedCloset(DistributedFurnitureItem.DistributedFurnitureItem):
    ...
    def _popupTimeoutPanel(self):
        ...
        self.popupInfo = DirectFrame(parent = hidden, relief = None, state = 'normal', text = TTLocalizer.ClosetTimeoutMessage, frameSize = (-1, 1, -1, 1), geom = DGG.getDefaultDialogGeom(), geom_color = ToontownGlobals.GlobalDialogColor, geom_scale = (0.88, 1, 0.45000000000000001), geom_pos = (0, 0, -0.080000000000000002), text_scale = 0.080000000000000002)
    ...
    def _DistributedCloset__popupNotOwnerPanel(self):
        ...
        DirectButton(self.popupInfo, image = okButtonImage, relief = None, text = TTLocalizer.ClosetPopupOK, text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), textMayChange = 0, pos = (0.0, 0.0, -0.20999999999999999), command = self._handleNotOwnerMessageOK)
        buttons.removeNode()
        self.popupInfo.reparentTo(aspect2d)
    ...
    def _DistributedCloset__popupAreYouSurePanel(self):
        ...
        DirectButton(self.popupInfo, image = okButtonImage, relief = None, text = TTLocalizer.ClosetPopupOK, text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), textMayChange = 0, pos = (-0.10000000000000001, 0.0, -0.20999999999999999), command = self._handleYesImSure)
        DirectButton(self.popupInfo, image = cancelButtonImage, relief = None, text = TTLocalizer.ClosetPopupCancel, text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), textMayChange = 0, pos = (0.10000000000000001, 0.0, -0.20999999999999999), command = self._handleNotSure)
        buttons.removeNode()
        self.popupInfo.reparentTo(aspect2d)
