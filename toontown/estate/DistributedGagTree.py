...
class DistributedGagTree(DistributedPlantBase.DistributedPlantBase):
    ...
    def loadModel(self):
        ...
        self.prop.setPos(0.10000000000000001, -0.17000000000000001, 1.6299999999999999)
        self.prop.reparentTo(self.signModel)
        self.prop2.setPos(0.14999999999999999, 0.17000000000000001, 1.6299999999999999)
        ...
        if queue.getNumEntries() > 0:
            ...
            for index in range(queue.getNumEntries()):
                ...
                if DistributedLawnDecor.recurseParent(entry.getIntoNode(), 'terrain_DNARoot'):
                    ...
                    self.signModel.setZ(entry.getSurfacePoint(render)[2] + self.stickUp + 0.10000000000000001)
    ...
    def velvetRoped(self):
        if not base.cr.isPaid():
            pass
        return ToontownBattleGlobals.gagIsPaidOnly(self.gagTrack, self.gagLevel)
