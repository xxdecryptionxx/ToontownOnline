...
class ClosetGUI(ClothesGUI.ClothesGUI):
    ...
    def load(self):
        ...
        if self.isOwner:
            ...
            self.trashPanel = DirectFrame(parent = aspect2d, image = DGG.getDefaultDialogGeom(), image_color = (1, 1, 0.75, 0.80000000000000004), image_scale = (0.35999999999999999, 0, 0.75), pos = (-0.85999999999999999, 0, -0.050000000000000003), relief = None)
