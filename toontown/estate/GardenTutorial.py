...
class GardenTutorial(DirectFrame, FSM.FSM):
    ...
    def __init__(self, doneEvent = None, callback = None):
        ...
        self.iPage1 = DirectFrame(self, image = images.find('**/GardenTutorialPage1'), scale = 0.34999999999999998, pos = (-0.51000000000000001, -0.10000000000000001, 0.050000000000000003))
        self.iPage1.hide()
        self.iPage2 = DirectFrame(self, image = images.find('**/GardenTutorialPage2'), scale = 1.25, pos = (0.42999999999999999, -0.10000000000000001, 0.050000000000000003))
        self.iPage2.hide()
        self.iPage3 = DirectFrame(self, image = images.find('**/GardenTutorialPage3'), scale = 0.5, pos = (-0.52000000000000002, -0.10000000000000001, 0.02))
        self.iPage3.hide()
        self.iPage4 = DirectFrame(self, image = images.find('**/GardenTutorialPage4'), scale = 0.75, pos = (0, -0.10000000000000001, -0.050000000000000003))
        self.iPage4.hide()
        self.iPage5 = DirectFrame(self, image = images.find('**/GardenTutorialPage5'), scale = 0.69999999999999996, pos = (-0.51000000000000001, -0.10000000000000001, 0.050000000000000003))
        self.iPage5.hide()
        buttons = loader.loadModel('phase_3/models/gui/dialog_box_buttons_gui')
        gui = loader.loadModel('phase_3.5/models/gui/friendslist_gui')
        self.bNext = DirectButton(self, image = (gui.find('**/Horiz_Arrow_UP'), gui.find('**/Horiz_Arrow_DN'), gui.find('**/Horiz_Arrow_Rllvr'), gui.find('**/Horiz_Arrow_UP')), image3_color = Vec4(1, 1, 1, 0.5), relief = None, text = TTLocalizer.GardenTutorialNext, text3_fg = Vec4(0, 0, 0, 0.5), text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), pos = (0.20000000000000001, -0.29999999999999999, -0.25), command = self.requestNext)
        self.bPrev = DirectButton(self, image = (gui.find('**/Horiz_Arrow_UP'), gui.find('**/Horiz_Arrow_DN'), gui.find('**/Horiz_Arrow_Rllvr'), gui.find('**/Horiz_Arrow_UP')), image3_color = Vec4(1, 1, 1, 0.5), image_scale = (-1.0, 1.0, 1.0), relief = None, text = TTLocalizer.GardenTutorialPrev, text3_fg = Vec4(0, 0, 0, 0.5), text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), pos = (-0.20000000000000001, -0.29999999999999999, -0.25), command = self.requestPrev)
        self.bQuit = DirectButton(self, image = (buttons.find('**/ChtBx_OKBtn_UP'), buttons.find('**/ChtBx_OKBtn_DN'), buttons.find('**/ChtBx_OKBtn_Rllvr')), relief = None, text = TTLocalizer.GardenTutorialDone, text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), pos = (0.55000000000000004, -0.29999999999999999, -0.25), command = self._GardenTutorial__handleQuit)
        self.bQuit.hide()
        buttons.removeNode()
        gui.removeNode()
