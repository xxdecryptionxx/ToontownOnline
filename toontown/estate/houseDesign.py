...
DisabledPickerPanelColor = (0.69999999999999996, 0.65000000000000002, 0.57999999999999996, 1)
DeletePickerPanelColor = (1, 0.40000000000000002, 0.40000000000000002, 1)
DisabledDeletePickerPanelColor = (0.69999999999999996, 0.29999999999999999, 0.29999999999999999, 1)
...
class FurnitureItemPanel(DirectButton):
    ...
    def __init__(self, item, itemId, command = None, deleteMode = 0, withinFunc = None, helpCategory = None):
        ...
        DirectButton.__init__(self, relief = DGG.RAISED, frameSize = (-0.25, 0.25, -0.20000000000000001, 0.20000000000000001), frameColor = framePanelColor, borderWidth = (0.02, 0.02), command = self.clicked)
        if self.deleteMode:
...
class ObjectManager(NodePath, DirectObject):
    ...
    def createMainControls(self, guiModels):
        ...
        self.furnitureGui.hide()
        self.helpText = DirectLabel(parent = self.furnitureGui, relief = DGG.SUNKEN, frameSize = (-0.5, 10, -3, 0.90000000000000002), frameColor = (0.20000000000000001, 0.20000000000000001, 0.20000000000000001, 0.5), borderWidth = (0.01, 0.01), text = '', text_wordwrap = 12, text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1), text_scale = 0.80000000000000004, pos = (3, 0.0, -7), scale = 1, text_align = TextNode.ALeft)
        self.helpText.hide()
