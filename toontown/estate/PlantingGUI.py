...
class GenericBoxScrollList(DirectScrolledList):
    ...
    def __init__(self, parent, items, **kw):
        ...
        self.forceHeight = 1
        optiondefs = (('parent', parent, None), ('relief', None, None), ('incButton_image', (gui.find('**/FndsLst_ScrollUp'), gui.find('**/FndsLst_ScrollDN'), gui.find('**/FndsLst_ScrollUp_Rllvr'), gui.find('**/FndsLst_ScrollUp')), None), ('incButton_relief', None, None), ('incButton_scale', (1.3, 1.3, -1.3), None), ('incButton_pos', (0, 0, -0.52500000000000002), None), ('incButton_image3_color', Vec4(0.80000000000000004, 0.80000000000000004, 0.80000000000000004, 0.5), None), ('decButton_image', (gui.find('**/FndsLst_ScrollUp'), gui.find('**/FndsLst_ScrollDN'), gui.find('**/FndsLst_ScrollUp_Rllvr'), gui.find('**/FndsLst_ScrollUp')), None), ('decButton_relief', None, None), ('decButton_scale', (1.3, 1.3, 1.3), None), ('decButton_pos', (0, 0, 0.52500000000000002), None), ('decButton_image3_color', Vec4(0.80000000000000004, 0.80000000000000004, 0.80000000000000004, 0.5), None), ('numItemsVisible', 1, None), ('items', items, None), ('scrollSpeed', 1.0, None), ('forceHeight', 1, None))
        gui.removeNode()
...
class JellyBeanPicker(DirectFrame):
    ...
    def __init__(self, parent, callBack, boxPosition, **kw):
        ...
        DirectFrame.__init__(self, relief = None, state = 'normal', geom = DGG.getDefaultDialogGeom(), geom_color = (0.80000000000000004, 0.80000000000000004, 0.80000000000000004, 1.0), geom_scale = JellyBeanPickerGeomScale, scale = JellyBeanPickerScale, frameSize = (-1, 1, -1, 1), pos = (0, 0, 0))
    ...
    def createJellyBeanBox(self, beanIndex, xPos, zPos):
        ...
        newBox = DirectButton(parent = self, pos = (xPos, 0, zPos), geom = DGG.getDefaultDialogGeom(), geom_scale = (0.10000000000000001, 1.0, 0.10000000000000001), geom_color = geomColor, scale = JellyBeanPickerScaleInverse, relief = None, state = state, command = command, extraArgs = [
            beanIndex], text = '', text_pos = (0.0, 0.10000000000000001), text_scale = 0.070000000000000007, text_fg = Vec4(0, 0, 0, 0), text1_fg = Vec4(0, 0, 0, 0), text2_fg = Vec4(0, 0, 0, 1), text3_fg = Vec4(0, 0, 0, 0))
        if JELLY_BEAN_PICKER_HAS_EMPTY_BOX:
            if beanIndex:
    ...
    def createJellyBeanBoxes(self):
        ...
        startingXCoord = -0.10000000000000001 * float(maxBoxes) / 2.0 + 0.074999999999999997
...
class PlantingGUI(DirectFrame):
    ...
    def __init__(self, doneEvent, specialBoxActive = False):
        ...
        DirectFrame.__init__(self, relief = None, state = 'normal', geom = DGG.getDefaultDialogGeom(), geom_color = ToontownGlobals.GlobalDialogColor, geom_scale = (1.5, 1.0, 1.0), frameSize = (-1, 1, -1, 1), pos = (0, 0, 0), text = instructions, text_wordwrap = 20, text_scale = 0.080000000000000002, text_pos = instructionsPos)
        ...
        self.cancelButton = DirectButton(parent = self, relief = None, image = cancelImageList, pos = (-0.29999999999999999, 0, -0.34999999999999998), text = TTLocalizer.PlantingGuiCancel, text_scale = 0.059999999999999998, text_pos = (0, -0.10000000000000001), command = self._PlantingGUI__cancel)
        self.okButton = DirectButton(parent = self, relief = None, image = okImageList, pos = (0.29999999999999999, 0, -0.34999999999999998), text = TTLocalizer.PlantingGuiOk, text_scale = 0.059999999999999998, text_pos = (0, -0.10000000000000001), command = self._PlantingGUI__doPlant)
        self.resetButton = DirectButton(parent = self, relief = None, image = resetImageList, pos = (0.0, 0, -0.34999999999999998), text = TTLocalizer.PlantingGuiReset, text_scale = 0.059999999999999998, text_pos = (0, -0.10000000000000001), command = self._PlantingGUI__reset)
        buttons.removeNode()
    ...
    def createBoxes(self):
        ...
        xPos = 0
        startingXCoord = -0.10000000000000001 * float(self.maxBoxes) / 2.0 + 0.050000000000000003
    ...
    def createSpecialBox(self, xPos, zPos):
        ...
        self.specialButton = GenericBoxScrollList(self.specialButtonFrame, items, incButton_pos = (0, 0, -0.13500000000000001), incButton_scale = (0.75, 1.0, -1.0), decButton_pos = (0, 0, 0.13500000000000001), decButton_scale = (0.75, 1.0, 1.0), command = self.photoSpecialChanged)
    ...
    def createScrollingBeanBox(self, index, xPos, zPos, active):
        ...
        boxFrame = DirectFrame(parent = self, pos = (xPos, 0, zPos), geom = DGG.getDefaultDialogGeom(), geom_scale = (0.10000000000000001, 1.0, 0.10000000000000001), geom_color = geomColor, relief = None)
        items = []
        if active:
        ...
        box = GenericBoxScrollList(boxFrame, items, incButton_pos = (0, 0, -0.070000000000000007), incButton_scale = (0.40000000000000002, 1.0, -1.0), decButton_pos = (0, 0, 0.065000000000000002), decButton_scale = (0.40000000000000002, 1.0, 1.0))
    ...
    def spiffyBeanBoxClicked(self, index):
        ...
        if DO_PICKER_INTERVAL:
            ...
            self.jellyBeanPickerInterval = Sequence(Parallel(self.jellyBeanPicker.posInterval(duration = 0.29999999999999999, pos = VBase3(*JellyBeanPickerEndPos)), self.jellyBeanPicker.scaleInterval(duration = 0.29999999999999999, startScale = VBase3(JellyBeanPickerScale[0] / 10.0, JellyBeanPickerScale[1], JellyBeanPickerScale[2]), scale = VBase3(*JellyBeanPickerScale))), Func(self.jellyBeanPicker.setColorText))
    ...
    def createSpiffyBeanBox(self, index, xPos, zPos, active):
        ...
        newBox = SpiffyBeanBox(index = index, parent = self, pos = (xPos, 0, zPos), geom = DGG.getDefaultDialogGeom(), geom_scale = (0.10000000000000001, 1.0, 0.10000000000000001), geom_color = geomColor, relief = None, state = state, command = command, extraArgs = [
            index])
