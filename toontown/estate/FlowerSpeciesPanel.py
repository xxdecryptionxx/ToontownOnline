...
class FlowerSpeciesPanel(DirectFrame):
    ...
    def __init__(self, species = None, itemIndex = 0, *extraArgs):
        ...
        optiondefs = (('relief', None, None), ('state', DGG.NORMAL, None), ('image', albumGui, None), ('image_scale', (0.025000000000000001, 0.025000000000000001, 0.025000000000000001), None), ('image_pos', (0, 1, 0), None), ('text', TTLocalizer.FlowerUnknown, None), ('text_scale', 0.065000000000000002, None), ('text_fg', (0.20000000000000001, 0.10000000000000001, 0.0, 1), None), ('text_pos', (-0.5, -0.34000000000000002), None), ('text_font', ToontownGlobals.getInterfaceFont(), None), ('text_wordwrap', 13.5, None), ('text_align', TextNode.ALeft, None))
    ...
    def setSpecies(self, species):
        ...
        if self.species != None:
            ...
            xAdj = -0.002
            self.flowerPanel.setPos(-0.22900000000000001 + xAdj, 1, -0.01 + zAdj)
            self.flowerPanel.setSwimBounds(-0.24610000000000001, 0.23669999999999999, -0.20699999999999999 + zAdj, 0.26640000000000003 + zAdj)
            ...
            for variety in range(len(varietyList)):
                label = DirectButton(parent = self, frameSize = (0, 0.44500000000000001, -0.02, 0.040000000000000001), relief = None, state = DGG.DISABLED, pos = (0.059999999999999998, 0, startPos - variety * offset), text = TTLocalizer.FlowerUnknown, text_fg = (0.20000000000000001, 0.10000000000000001, 0.0, 1), text_scale = (0.044999999999999998, 0.044999999999999998, 0.45000000000000001), text_align = TextNode.ALeft, text_font = ToontownGlobals.getInterfaceFont(), command = self.changeVariety, extraArgs = [
                    variety], text1_bg = Vec4(1, 1, 0, 1), text2_bg = Vec4(0.5, 0.90000000000000002, 1, 1), text3_fg = Vec4(0.40000000000000002, 0.80000000000000004, 0.40000000000000002, 1))
    ...
    def createBeanRecipeGui(self, recipe):
        ...
        self.beanRecipeGui = BeanRecipeGui.BeanRecipeGui(aspect2dp, recipe, pos = pos4, scale = 1.3, frameColor = (0.80000000000000004, 0.80000000000000004, 0.80000000000000004, 1.0))
