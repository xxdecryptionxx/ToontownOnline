...
class Estate(Place.Place):
    ...
    def startAprilFoolsControls(self):
        if isinstance(base.localAvatar.controlManager.currentControls, GravityWalker):
            base.localAvatar.controlManager.currentControls.setGravity(32.173999999999999 * 0.75)
        

    
    def stopAprilFoolsControls(self):
        if isinstance(base.localAvatar.controlManager.currentControls, GravityWalker):
            base.localAvatar.controlManager.currentControls.setGravity(32.173999999999999 * 2.0)
    ...
    def enterMailbox(self):
        ...
        base.localAvatar.startSleepWatch(self._Estate__handleFallingAsleepMailbox)
