...
class DistributedEstate(DistributedObject.DistributedObject):
    ...
    def load(self):
        ...
        base.win.setClearColor(Vec4(0.089999999999999997, 0.55000000000000004, 0.20999999999999999, 1.0))
    ...
    def loadWitch(self):
        ...
        replacement = Sequence(LerpColorScaleInterval(self.airplane, 0.10000000000000001, Vec4(1, 1, 1, 0)), Func(__replaceAirplane__), LerpColorScaleInterval(self.airplane, 0.10000000000000001, Vec4(1, 1, 1, 1)))
        replacement.start()
    ...
    def unloadWitch(self):
        ...
        replacement = Sequence(LerpColorScaleInterval(self.airplane, 0.10000000000000001, Vec4(1, 1, 1, 0)), Func(__replaceWitch__), LerpColorScaleInterval(self.airplane, 0.10000000000000001, Vec4(1, 1, 1, 1)))
        replacement.start()
    ...
    def loadFlowerSellBox(self):
        ...
        self.flowerSellBox.setPos(-142.58600000000001, 4.3529999999999998, 0.025000000000000001)
        self.flowerSellBox.reparentTo(render)
        colNode = self.flowerSellBox.find('**/collision')
        colNode.setName('FlowerSellBox')
        self.accept('enterFlowerSellBox', self._DistributedEstate__touchedFlowerSellBox)
    ...
    def popupFlowerGUI(self):
        self.acceptOnce(self.flowerGuiDoneEvent, self._DistributedEstate__handleSaleDone)
