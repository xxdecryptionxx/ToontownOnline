                        ...
                        if movingSprite.isActive or testSprite.isActive:
                            if movingSprite.isQue or testSprite.isQue:
                                ...
                                if not movingSprite.isActive and testSprite.isActive:
                                    self._GardenDropGame__collide(movingSprite, testSprite)
