...
class DistributedToonStatuary(DistributedStatuary.DistributedStatuary):
    ...
    def setStoneTexture(self):
        gray = VBase4(1.6000000000000001, 1.6000000000000001, 1.6000000000000001, 1)
        ...
        if self.toon.hasLOD():
            for lodName in self.toon.getLODNames():
                ...
                eyes = head.find('**/eye*')
                if not eyes.isEmpty():
                    eyes.setColor(Vec4(1.3999999999999999, 1.3999999999999999, 1.3999999999999999, 0.29999999999999999), 10)
                ...
                if ears != ears.notFound():
                    if self.speciesType == 'cat':
                        ...
                        ears.setTexture(tsDetail, stoneTex)
                        ears.setColor(VBase4(0.59999999999999998, 0.90000000000000002, 1, 1), 10)
