...
class FlowerPicker(DirectScrolledList):
    ...
    def __init__(self, parent = aspect2d, **kw):
        ...
        self.info = DirectLabel(parent = self, relief = None, text = '', text_scale = TTLocalizer.FPinfo, pos = (0.17999999999999999, 0, -0.67000000000000004))
        self.flowerPanel = FlowerPanel.FlowerPanel(parent = self)
        self.flowerPanel.setSwimBounds(-0.29999999999999999, 0.29999999999999999, -0.23499999999999999, 0.25)
    ...
    def makeFlowerButton(self, flower):
        return DirectScrolledListItem(parent = self, relief = None, text = flower.getFullName(), text_scale = 0.070000000000000007, text_align = TextNode.ALeft, text1_fg = Vec4(1, 1, 0, 1), text2_fg = Vec4(0.5, 0.90000000000000002, 1, 1), text3_fg = Vec4(0.40000000000000002, 0.80000000000000004, 0.40000000000000002, 1), command = self.showFlowerPanel, extraArgs = [
            flower])
