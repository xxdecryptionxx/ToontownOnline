...
class DistributedTrunk(DistributedCloset.DistributedCloset):
    ...
    def popupChangeClothesGUI(self, task):
        ...
        self.accept(self.purchaseDoneEvent, self._DistributedTrunk__proceedToCheckout)
        self.accept(self.swapHatEvent, self._DistributedTrunk__handleSwapHat)
        self.accept(self.swapGlassesEvent, self._DistributedTrunk__handleSwapGlasses)
        self.accept(self.swapBackpackEvent, self._DistributedTrunk__handleSwapBackpack)
        self.accept(self.swapShoesEvent, self._DistributedTrunk__handleSwapShoes)
