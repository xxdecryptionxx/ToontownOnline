...
class FireworkItemPanel(DirectFrame):
    ...
    def load(self):
        self.picture = DirectButton(parent = self, image = (DGG.getDefaultDialogGeom(), DGG.getDefaultDialogGeom(), DGG.getDefaultDialogGeom()), relief = None, command = self._FireworkItemPanel__launchFirework, extraArgs = [
