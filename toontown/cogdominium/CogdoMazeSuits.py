...
class CogdoMazeSuit(MazeSuit, FSM, CogdoMazeSplattable):
    ...
    def _initSfx(self):
        ...
        self._deathSoundIval = Sequence(audioMgr.createSfxIval('cogSpin', duration = 1.6000000000000001, startTime = 0.59999999999999998, volume = 0.80000000000000004, source = self.deathSuit), audioMgr.createSfxIval('cogDeath', volume = 0.32000000000000001, source = self.deathSuit))
...
class CogdoMazeBossSuit(CogdoMazeSuit):
    ...
    def _initSfx(self):
        ...
        audioMgr = base.cogdoGameAudioMgr
        self._stompSfxIval = audioMgr.createSfxIval('cogStomp', source = self.suit, cutoff = Globals.BossStompSfxCutoff, volume = 0.29999999999999999)
    ...
    def _CogdoMazeBossSuit__startShakeTask(self):
        self._CogdoMazeBossSuit__stopShakeTask()
        taskMgr.doMethodLater(Globals.BossShakeTime, self._CogdoMazeBossSuit__shake, self.uniqueName(CogdoMazeBossSuit.ShakeTaskName))
    ...
    def _CogdoMazeBossSuit__startBlinkTask(self):
        self._CogdoMazeBossSuit__stopBlinkTask()
        taskMgr.doMethodLater(Globals.BlinkFrequency, self._CogdoMazeBossSuit__blink, CogdoMazeBossSuit.BlinkTaskName)
