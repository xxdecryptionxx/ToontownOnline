...
class CogdoGameGatherable(NodePath, DirectObject):
    ...
    def __init__(self, serialNum, model, triggerRadius, triggerOffset = (0, 0, 0), animate = True, animDuration = 0.20000000000000001, instanceModel = True, name = 'CogdoGameGatherable'):
    ...
    def pickUp(self, toon, elapsedSeconds = 0.0):
        ...
        if self._animate:
            ...
            self._animSeq = Sequence(LerpFunc(lerpFlyToToon, fromData = 0.0, toData = 1.0, duration = self._animDuration), Wait(0.10000000000000001), Func(self.hide))
