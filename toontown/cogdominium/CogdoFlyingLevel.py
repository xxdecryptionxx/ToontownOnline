...
class CogdoFlyingLevel(DirectObject):
    ...
    def _initStartEndPlatforms(self):
        ...
        self.backLimit = self._startPlatformModel.getY(render) - Globals.Level.StartPlatformLength * 0.69999999999999996
        self.forwardLimit = self._endPlatformModel.getY(render) + Globals.Level.EndPlatformLength * 0.69999999999999996
