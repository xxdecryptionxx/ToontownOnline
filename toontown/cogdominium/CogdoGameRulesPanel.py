...
class CogdoGameRulesPanel(StateData.StateData):
    ...
    def load(self):
        ...
        self.gameTitleText = DirectLabel(parent = self.frame, text = self.gameTitle, scale = TTLocalizer.CRPgameTitleText, text_align = TextNode.ACenter, text_font = getSignFont(), text_fg = (1.0, 0.33000000000000002, 0.33000000000000002, 1.0), pos = TTLocalizer.CRPgameTitleTextPos, relief = None)
        ...
        self.playButton = DirectButton(parent = self.frame, relief = None, geom = (minigameGui.find('**/buttonUp'), minigameGui.find('**/buttonDown'), minigameGui.find('**/buttonHover')), pos = (0.73999999999999999, 0, 0.10000000000000001), scale = (4.2000000000000002, 5, 5), command = self.playCallback)
