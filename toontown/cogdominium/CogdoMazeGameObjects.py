...
class CogdoMazeDrop(NodePath, DirectObject):
    ...
    def __init__(self, game, id, x, y):
        ...
        self.drop = drop
        self._dropSfx = base.cogdoGameAudioMgr.createSfxIval('drop', volume = 0.59999999999999998)
    ...
    def getDropIval(self):
        ...
        dropShakeSeq = Sequence(LerpScaleInterval(self.drop, 0.25, Vec3(1.0 + scaleChange, 1.0 + scaleChange / 2, 1.0 - scaleChange), blendType = 'easeInOut'), LerpScaleInterval(self.drop, 0.25, Vec3(1.0, 1.0, 1.0), blendType = 'easeInOut'), Func(self.disableCollisionDamage), LerpScaleInterval(self.drop, 0.20000000000000001, Vec3(1.0 + scaleChange / 8, 1.0 + scaleChange / 8, 1.0 - scaleChange / 8), blendType = 'easeInOut'), LerpScaleInterval(self.drop, 0.20000000000000001, Vec3(1.0, 1.0, 1.0), blendType = 'easeInOut'), LerpScaleInterval(self.drop, 0.14999999999999999, Vec3(1.0 + scaleChange / 16, 1.0 + scaleChange / 16, 1.0 - scaleChange / 16), blendType = 'easeInOut'), LerpScaleInterval(self.drop, 0.14999999999999999, Vec3(1.0, 1.0, 1.0), blendType = 'easeInOut'), LerpScaleInterval(self.drop, 0.10000000000000001, Vec3(1.0 + scaleChange / 16, 1.0 + scaleChange / 8, 1.0 - scaleChange / 16), blendType = 'easeInOut'), LerpColorScaleInterval(self.drop, Globals.DropFadeTime, Vec4(1.0, 1.0, 1.0, 0.0)))
