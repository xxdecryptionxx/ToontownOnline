...
class DistCogdoGame(DistCogdoGameBase, DistributedObject):
    ...
    def __init__(self, cr):
        ...
        base.cogdoGame = self
        self._waitingStartLabel = DirectLabel(text = TTL.MinigameWaitingForOtherPlayers, text_fg = VBase4(1, 1, 1, 1), relief = None, pos = (-0.59999999999999998, 0, -0.75), scale = 0.074999999999999997)
