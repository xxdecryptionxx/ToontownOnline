...
class CogdoMemoGui(DirectFrame):
    ...
    def _initModel(self):
        self._countLabel = DirectLabel(parent = self, relief = None, pos = (0.0625, 0, -0.025000000000000001), scale = CogdoGameConsts.MemoGuiTextScale, text = str(0), text_fg = CogdoGameConsts.MemoGuiTextColor, text_shadow = (0.20000000000000001, 0.20000000000000001, 0.20000000000000001, 1), text_align = TextNode.ALeft, text_font = ToontownGlobals.getToonFont())
