...
class CogdoMazeCameraManager:
    ...
    def _updateCameraDistance(self):
        if self._camDistance < self._camTargetDistance:
            self._camDistance += min(0.40000000000000002 * (self._camDistance / self._camTargetDistance), self._camTargetDistance - self._camDistance)
        elif self._camDistance > self._camTargetDistance:
            self._camDistance += max(-0.40000000000000002 * (self._camDistance / self._camTargetDistance), self._camTargetDistance - self._camDistance)
